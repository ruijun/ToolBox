...
public class MyDataBaseAdapter {
	...
	public Cursor fetchAllData() {
		return mSQLiteDatabase.query(TABLE_NAME, new String[] { TABLE_ID,
				TABLE_rNAME, TABLE_PATH }, null, null, null, null, null);
	}
	...
	public Cursor fetchData(long rowId) throws SQLException {
		...
		mSQLiteDatabase.query(true, TABLE_NAME, new String[] { TABLE_ID,
				TABLE_rNAME, TABLE_PATH }, TABLE_ID + "=" + rowId, null, null,
				null, null, null);
	...
	public boolean updateData(int id, String name, String path) {
		...
		return mSQLiteDatabase.update(TABLE_NAME, args, TABLE_ID + "=" + id,
				null) > 0;
	}
	...
	public String getPath(int id) {
		...
		Cursor c = mSQLiteDatabase.query(true, TABLE_NAME, new String[] {
				TABLE_ID, TABLE_rNAME, TABLE_PATH },
				TABLE_ID + "=" + Integer.toString(id), null, null, null, null,
				null);
		if (c.moveToFirst()) {
	...
	public void updateID(int id) {
		...
		for (int i = nums - id; i >= 0; i--) {
			...
			mSQLiteDatabase.update(TABLE_NAME, args, TABLE_ID + "=" + nextID,
					null);
			nextID++;
