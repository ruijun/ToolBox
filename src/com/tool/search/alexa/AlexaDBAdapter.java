...
public class AlexaDBAdapter {
	public static final String KEY_ID 		="_id";
	public final static String KEY_TITLE 	= "title";
	public final static String KEY_RANK 	= "rank";
	public final static String KEY_REFERRERS	= "referrers";
	public final static String KEY_SPEED 	= "speed";
	
	private static final String DATABASE_NAME 	= "alDb";
	private static final String DATABASE_TABLE	= "alTab";
	private static final int DATABASE_VERSION 	= 1;
	private static final String DATABASE_CREATE = "create table alTab (_id integer primary key autoincrement, "
			+ "title text not null,rank text not null," 
			+"referrers text not null," 
			+"speed text not null);";
			
	
	public static final String KEY_ALL[] = {
		KEY_ID,KEY_TITLE,KEY_RANK,KEY_REFERRERS,KEY_SPEED
	};
	...
	public AlexaDBAdapter(Context context) {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			db.execSQL("DROP TABLE IF EXISTS alTab");
			onCreate(db);
		}
	}
	
	/** ---打开数据库--- */
	public AlexaDBAdapter open()throws SQLException {
