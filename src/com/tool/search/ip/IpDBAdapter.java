...
public class IpDBAdapter {
	...
	private static final String DATABASE_TABLE	= "ipTab";
	private static final int DATABASE_VERSION 	= 1;
	private static final String DATABASE_CREATE = "create table ipTab (_id integer primary key autoincrement, "
			+ "ip text not null,location text not null);";
	
	public static final String KEY_ALL[] = {
		KEY_ID,KEY_IP,KEY_LOCATION
	};
	...
	public IpDBAdapter(Context context) {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			db.execSQL("DROP TABLE IF EXISTS ipTab");
			onCreate(db);
		}
	}
	
	/** ---打开数据库--- */
	public IpDBAdapter open()throws SQLException {
