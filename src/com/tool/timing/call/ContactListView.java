...
public class ContactListView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		homeBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(ContactListView.this, MainActivity.class);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView parent, View view,
				...
				//选中则加入选中字符串中,取消则从字符串中删除
					...
					//Toast.makeText(ContactListView.this, String.valueOf(position)+" "+numberStr, Toast.LENGTH_LONG).show();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event){
 		 if (keyCode == KeyEvent.KEYCODE_BACK){
 			 Intent intent = new Intent(ContactListView.this, TimingDialActivity.class);
 			 startActivity(intent);
 			 ContactListView.this.finish();
 		 }
 		 return false;
        ...
        public void onTextChanged(CharSequence s, int start,
        	...
        	if(autoText.length()>=13){
        		...
        		if(mc.find()){
        			...
        			//刷新列表
        			ToastManager.showToastView(ContactListView.this, "已选中您搜索的结果!");
...
//		 cursor.close(); }
	    	...
	    	final CharSequence[] dialog_items = {"确定添加","取消"};
					Dialog dialog = new AlertDialog.Builder(ContactListView.this)
